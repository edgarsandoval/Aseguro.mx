...
<head>
	...
	{{ HTML::style( asset('css/promesa-aseguro.css')) }}
	{{ HTML::style( asset('css/aseguros.css')) }}
	{{ HTML::style( asset('css/contacto.css')) }}
	...
	{{ HTML::script( asset('js/cotiza.js')) }}
...
<body>
	...
	<div id="promesa-aseguro">
		@yield('promesa-aseguro')
	</div>
				...
				<div style="border-bottom: 2px solid #EC4424;">
					<div class="row">
						<div class="col-md-6 gidole" style="font-size: .8vw; text-align: center;">
							<i class="fa fa-envelope"></i>&nbsp;contacto@aseguro.mx
						</div>
